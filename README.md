...
* Delete key-value pairs from the BST
* Iterator for iterating over the key-value pairs in ascending order

## `BST` implementation [module src](https://github.com/Andn1ght/LabWork5/blob/master/src/service/BST.java) 📈:
```java
